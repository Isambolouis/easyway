...
export function StatsQuizCard({
  ...
  return (
    <div className="scroll-x-card my-6 rounded-2xl border border-sky-200 bg-gradient-to-br from-sky-50 to-white p-5 shadow-md">
      <p className="mb-3 text-xs font-bold uppercase tracking-wider text-sky-700">Quiz rapide</p>
            ...
            <li key={opt.id}>
              <button
                ...
                className={cn(
                  ...
                  !done && 'hover:border-sky-400 hover:bg-sky-50/50',
