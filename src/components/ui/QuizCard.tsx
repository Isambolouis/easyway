...
const optionHover =
  'hover:border-teal hover:bg-teal-50/50 dark:hover:border-teal/60 dark:hover:bg-teal-950/40'
...
export function QuizCard({
  ...
  return (
    <div className="scroll-x-card my-8 rounded-2xl border border-violet-200 bg-gradient-to-br from-violet-50 to-white p-5 shadow-md dark:border-violet-500/35 dark:from-violet-950/55 dark:to-[var(--color-card)] dark:shadow-black/20">
