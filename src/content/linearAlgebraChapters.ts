...
export const linearAlgebraChapters: (ChapterMeta & { level: number })[] = [
  ...
  { id: 'al8', slug: 'methode-gauss', number: 8, level: 2, title: 'Méthode de Gauss', description: 'Matrice augmentée, élimination, forme échelonnée.', icon: ListOrdered },
  { id: 'al9', slug: 'produit-scalaire-vectoriel', number: 9, level: 3, title: 'Produit scalaire et orthogonalité', description: 'Dot product, angles, cosine similarity et applications vision.', icon: Target },
  { id: 'al10', slug: 'projections', number: 10, level: 3, title: 'Projection orthogonale', description: 'Proj sur vecteur, matrices P, PCA et vision.', icon: Layers },
  { id: 'al11', slug: 'multiplication-matrices', number: 11, level: 2, title: 'Multiplication & transformations', description: 'Produit matriciel et applications linéaires.', icon: GitMerge, comingSoon: true },
  { id: 'al12', slug: 'inverse-transposee', number: 12, level: 2, title: 'Inverse & transposée (approfondissement)', description: 'Propriétés avancées et cas particuliers.', icon: ArrowRightLeft, comingSoon: true },
  { id: 'al13', slug: 'rotations-base', number: 13, level: 3, title: 'Rotations & changement de base', description: 'Matrices de rotation et repères.', icon: RotateCw, comingSoon: true },
  { id: 'al14', slug: 'vision-transformations', number: 14, level: 3, title: 'Vision par ordinateur', description: 'Homographies, 3D → 2D, images.', icon: Move3d, comingSoon: true },
  { id: 'al15', slug: 'valeurs-propres', number: 15, level: 4, title: 'Valeurs & vecteurs propres', description: 'Diagonalisation et interprétation.', icon: Sparkles, comingSoon: true },
  { id: 'al16', slug: 'svd', number: 16, level: 4, title: 'Décomposition SVD', description: 'Singular Value Decomposition.', icon: Boxes, comingSoon: true },
  { id: 'al17', slug: 'pca', number: 17, level: 4, title: 'PCA', description: 'Réduction de dimension.', icon: TrendingUp, comingSoon: true },
  { id: 'al18', slug: 'applications-ia', number: 18, level: 4, title: 'Applications IA & vision', description: 'Cas pratiques en machine learning.', icon: LineChart, comingSoon: true },
]
